<div class="row">
    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
      <div class="d-grid gap-2 col-6 mx-auto">
        <button class="btn btn-secondary mb-4" type="button">Add Record</button>
      </div>
                    ...
                    <tbody>
                            ...
                            <td>
                                <div class="d-flex">
                                    <div class="usr-img-frame mr-2 rounded-circle">
                                        <img alt="avatar" class="img-fluid rounded-circle" src="<?=base_url();?>src/assets/img/boy.png">
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <div class="usr-img-frame mr-2 rounded-circle">
                                        <img alt="avatar" class="img-fluid rounded-circle" src="<?=base_url();?>src/assets/img/boy-2.png">
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <div class="usr-img-frame mr-2 rounded-circle">
                                        <img alt="avatar" class="img-fluid rounded-circle" src="<?=base_url();?>src/assets/img/girl-1.png">
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <div class="usr-img-frame mr-2 rounded-circle">
                                        <img alt="avatar" class="img-fluid rounded-circle" src="<?=base_url();?>src/assets/img/girl-3.png">
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <div class="usr-img-frame mr-2 rounded-circle">
                                        <img alt="avatar" class="img-fluid rounded-circle" src="<?=base_url();?>src/assets/img/girl-2.png">
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <div class="usr-img-frame mr-2 rounded-circle">
                                        <img alt="avatar" class="img-fluid rounded-circle" src="<?=base_url();?>src/assets/img/girl-4.png">
                                    </div>
                                </div>
                            </td>
                            <td>
